 ...
 * mode line below.
 *
 * Source: https://brainless.swerdlow.dev (claude-prompt, MIT).
 */
			...
			>
				...
				<input
					...
					className={cn(
						...
						"focus-visible:bg-white/[0.04] focus-visible:outline focus-visible:outline-1 focus-visible:-outline-offset-1 focus-visible:outline-[#7dcfff]/60",
						inputClassName,
					)}
					style={
						{
